...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime} msg_from 'element-ui/src/utils/date-util';
  import Locale msg_from 'element-ui/src/mixins/locale';
  import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } msg_from 'element-ui/src/utils/util';
  ...
  // remove the first element that satisfies `pred` msg_from arr
